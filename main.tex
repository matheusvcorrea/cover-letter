...
% Your address
\setkomavar{fromaddress}{% João Maldonado Street\\Assis-SP,%
  Brazil}

% Your phone number
\setkomavar{fromphone}{\(+55\ 11\ 996174\ 8484\)}
...
\setkomavar{place}{%Assis-SP, Brazil
}
...
\firstfoot{%
  ...
  \href{}{www.linkedin.com/in/matheusvcorrea}%
}
...
\begin{letter}{~ % Addressed to the company you are applying to
  ...
  % I'm thrilled to apply for Machine Learning Engineer positions and
  ...
  %   engineering and its life cycle under microservices architecture.
